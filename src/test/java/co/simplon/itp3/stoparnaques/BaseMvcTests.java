...
class BaseMvcTests {
    ...
    @DisplayName("Parameterized Security Tests")
    @ParameterizedTest
    @CsvFileSource(resources = "/db/schema-tests.ddl.sql", delimiter = ',', numLinesToSkip = 1)
    void securityTests(String method, String path,
