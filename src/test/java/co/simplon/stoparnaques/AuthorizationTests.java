...
class AuthorizationsTests extends BaseMvcTests {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/csv/authorized.csv", delimiter = DELIMITER, numLinesToSkip = 1)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/csv/denied.csv", delimiter = DELIMITER, numLinesToSkip = 1)
